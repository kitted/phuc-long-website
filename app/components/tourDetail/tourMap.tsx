...
export default function TourMap({ locations }: TourMapProps) {
    ...
    useEffect(() => {
        ...
        const routeFeature = new Feature({
            geometry: new LineString(locations.map((loc) => fromLonLat([loc.lon, loc.lat]))),
        });
    ...
    return (
        // <div className='max-w-[1440px] h-full flex justify-center'>
            <div
                ref={mapRef}
                className="w-[30vw] h-[300px] mx-auto rounded-xl shadow max-md:w-[90vw] max-[800px]:order-1"
                style={{
